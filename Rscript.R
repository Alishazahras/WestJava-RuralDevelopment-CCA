...
data.RawCom <- read_excel("C:/Users/Alisha Zahra/Documents/Kuliah/SEMESTER 6/Multivariate/AOL/RuralCommunityFacilities.xlsx")
...
data.RawChar <- read_excel("C:/Users/Alisha Zahra/Documents/Kuliah/SEMESTER 6/Multivariate/AOL/RuralCommunityCharacteristics.xlsx", sheet = "All")
data.RawChar
